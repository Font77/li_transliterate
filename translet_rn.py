...
if __name__ == '__main__':
    ...
    ustr_uRiya = u'अनुप्रिया वर्मा, मुंबई। जैसे धरती के गर्भ में क्या क्या छिपा है किसी को नहीं पता। लगता है ठीक वैसा ही हाल बाहुबली का है। रिलीज़ को तीन हफ़्ते से कम समय बचा है लेकिन अब भी कुछ न कुछ हैरान करने वाली ख़बरें आ रही हैं। अब मामला उस महा सीन का है, जिसके बारे में सुनकर आ चौक जाएंगे।'
    uobj_uRiya = unicode_teqst.unicode_teqst(ustr_uRiya)
    print 'ustr_uRiya  ', uobj_uRiya.ditAqttr()
